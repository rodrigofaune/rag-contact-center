...
from .tools.bulk_upload_drive import bulk_upload_drive
...
root_agent = Agent(
    ...
    9. If they want to upload a large number of documents from Google Drive, use the `bulk_upload_drive` tool.
